...
@given('the container (?P<container>prefect|rs-server-frontend|rs-server-adgs|rs-server-cadip|rs-server-staging|\
    rs-server-catalog|pgstac) has got version (?P<version>[^"]+)')
@then('the container (?P<container>prefect|rs-server-frontend|rs-server-adgs|rs-server-cadip|rs-server-staging|\
    rs-server-catalog|pgstac) has got version (?P<version>[^"]+)')
